...
export default function Rating({ value }) {
  ...
  for (let i = 1; i <= 5; i++) {
    if (i <= filledStars) {
      ...
      stars.push(
        <svg key={i} className="star half-filled" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M12 2.75l2.792 6.854h7.208l-5.833 4.48 2.792 6.854-5.833-4.48-5.833 4.48 2.792-6.854-5.833-4.48h7.208z" />
      ...
      stars.push(
        <svg key={i} className="star empty" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path d="M12 2.75l2.792 6.854h7.208l-5.833 4.48 2.792 6.854-5.833-4.48-5.833 4.48 2.792-6.854-5.833-4.48h7.208z" />
        </svg>
      );
    }
